...
const styles = {
  footer: "pt-[40px] px-0 pb-[30px] md:pt-[0] md:pb-[100px] xl:pt-[87px] xl:px-0 xl:pb-[138px]",
  top: cn(
  ...
  logoBlock: "flex lg:block justify-between items-start md:items-center col-start-1 col-end-3 lg:col-end-1",
  outerInfo: {
    wrapper: "justify-start md:justify-between w-[138px] md:w-[185px] min-h-[24px] lg:mt-[35px]",
